...
새로고침하거나 브라우저를 다시 열면 다시 로그인해야 하며 백그라운드 재시도는 하지 않습니다.
...
퇴관일은 사용자별로 저장하지 않습니다. Supabase의 비공개 운영 일정표를 사용하고 화면에
적용 학기·갱신일·출처를 표시하며, 다음 학기 일정이 공지되기 전에는 날짜를 추측해 자동 신청하지 않습니다.
