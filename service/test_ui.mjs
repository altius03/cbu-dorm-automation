...
assert.match(html, /:root\[data-theme="dark"\][\s\S]*--page: #0a0d13[\s\S]*--surface: #202a38[\s\S]*--field: #111820/);
...
assert.match(script, /themeColor\.content = theme === "dark" \? "#0a0d13" : "#ffffff"/);
