...
assert.match(html, /\.side-column \{ display: contents; \}[\s\S]*\.club-panel \{ order: 3; \}/);
assert.match(html, /class="side-column"[\s\S]*class="panel control-panel"[\s\S]*class="panel club-panel"/);
