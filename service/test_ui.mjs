...
assert.match(html, /:root\[data-theme="dark"\][\s\S]*--page: #080b12[\s\S]*--surface: #111827[\s\S]*--field: #0b1220/);
...
assert.match(script, /themeColor\.content = theme === "dark" \? "#080b12" : "#ffffff"/);
